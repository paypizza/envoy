EXTENSIONS = {
    ...
    "envoy.filters.http.language": "@envoy_custom//src/extensions/filters/http/language:config",
...
EXTENSION_CONFIG_VISIBILITY = ["@envoy//:extension_config"]
EXTENSION_PACKAGE_VISIBILITY = ["@envoy//:extension_library"]
